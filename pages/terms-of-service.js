  ...
  return (
    <div className='container'>
      ...
      <main>
        ...
        <h5>
          <em>Effective Date: 01 June 2021</em>
        </h5>
        <h3>Overview</h3>
        <p>
          This website is operated by D&apos; Little Bread Cafe. Throughout the
          site, the terms “we”, “us” and “our” refer to D&apos; Little Bread
          Cafe. D&apos; Little Bread Cafe offers this website, including all
        ...
        <p>
          Our store is hosted on Vercel Inc. They provide us with the online
        ...
        <h3>Modifications to the Service and Price</h3>
        ...
        <p>
          ...
          by us) provided &lsquo;as is&rsquo; and &lsquo;as available&rsquo; for
        ...
        <p>
          In no case shall D Little Bread Cafe, our directors, officers,
        ...
        <p>
          You agree to indemnify, defend and hold harmless D Little Bread Cafe
        ...
        <ul>
          <li>
            By email:{' '}
            <a href='mailto:c3.foodbev@gmail.com'>
              <span>c3.foodbev@gmail.com</span>
            </a>
          </li>
          <li>
        ...
        <table>
          <tbody>
            <tr>
              <td valign='top' style={{ width: '182px', padding: '10px' }}>
                Postal Address :
              </td>
              <td valign='top' style={{ padding: '10px' }}>
                04-07 <br />
                Pangsapuri Akasia Persiaran Bukit Sungai Long
                <br />
                43000 Kajang
                <br />
