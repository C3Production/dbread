  ...
  return (
    <div className='container'>
      ...
      <main>
        ...
        <p>
          D Little Bread Cafe (“us”, “we”, or “our”) operates the{' '}
          <a href='https://dbread.vercel.app/'>https://dbread.vercel.app/</a>{' '}
        ...
        <ul>
          <li>
            <p>
              ...
              <br />
              Service is the{' '}
              <a href='https://dbread.vercel.app/'>
                https://dbread.vercel.app/
              </a>{' '}
              website operated by D Little Bread Cafe.
            </p>
          </li>
          <li>
            <p>
        ...
        <h5>Type of Data Collected</h5>
        <h6>Transaction Data</h6>
        <p>
          Transaction information, such as product purchased, price, method of
        ...
        <ul>
          <li>Email address</li>
          <li>Phone Number</li>
          <li>Username, First name, Last name</li>
          <li>Date of Birth</li>
          <li>Nationality, Gender, Race</li>
          <li>Particular of Identity Card (IC), passport</li>
          <li>Address, State, Province, ZIP/Postal code, City</li>
          <li>Image, Closed Circuit Television (CCTV) recording</li>
        ...
        <h3>Use of Data</h3>
        <p>D Little Bread Cafe uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          If you are from the European Economic Area (EEA), D Little Bread Cafe
        ...
        <p>D Little Bread Cafe may process your Personal Data because:</p>
        <ul>
        ...
        <p>
          D Little Bread Cafe will retain your Personal Data only for as long as
        ...
        <p>
          D Little Bread Cafe will also retain Usage Data for internal analysis
        ...
        <p>
          If you are located outside Malaysia and choose to provide information
          to us, please note that we transfer the data, including Personal Data,
          to Malaysia and process it there.
        </p>
        <p>
        ...
        <p>
          D Little Bread Cafe will take all the steps reasonably necessary to
        ...
        <p>
          Under certain circumstances, D Little Bread Cafe may be required to
        ...
        <p>
          D Little Bread Cafe may disclose your Personal Data in the good faith
          belief that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>
            To protect and defend the rights or property of D Little Bread Cafe
          </li>
          <li>
        ...
        <p>
          ...
          Service (&ldquo;Service Providers&rdquo;), provide the Service on our
        ...
        <ul>
          <li>
            <p>
              ...
              contextualise and personalize the ads of its own advertising
              network.
            </p>
            <p>
        ...
        <h3>Party Names</h3>
        <p>
          Throughout this Statement, &ldquo;D&apos; Bread&rdquo; refers to D
          Little Bread Cafe (Business Registration No.:
          202103189300(003287573-D)), the Licensee of D Little Bread Cafe under
          Registration of Businesses Act 1956 [Act 197] in Malaysia.
        </p>
        <h3>Contact Us</h3>
        <p>
